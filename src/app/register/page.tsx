...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Simulate Registration Logic / API Call
      ...
      <div className="relative z-10 w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">
            Join ReMobile to explore and buy verified smartphones
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-2 pt-1">
              <input
                ...
                onChange={handleChange}
                className="mt-0.5 accent-blue-600 rounded cursor-pointer w-4 h-4"
              />
              <label htmlFor="agreeTerms" className="text-xs text-slate-600 dark:text-slate-400 cursor-pointer leading-tight">
                I agree to the{' '}
